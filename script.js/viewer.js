...
const REGION_FALLBACK = {
  ...
  function updateConditionText(type) {
    const t = normalizeType(type);   // <--- added
  ...
  // -------------------------------------------------------------------
  // 6) OG Custom dropdown (eczema type)
  // -------------------------------------------------------------------
  //if (eczemaDropdown && dropdownSelected && dropdownOptions) {
    ...
    //dropdownOptions.forEach(option => {
      //option.addEventListener('click', () => {
        ...
        //const val = normalizeType(rawVal);  
        ...
        // clear region if current isn’t valid for this type
  ...
  //}
// -------------------------------------------------------------------
  // 6A) After it stopped working:  Custom dropdown (eczema type)
  // -------------------------------------------------------------------
//const eczemaDropdown   = document.getElementById('eczemaDropdown');
//const dropdownSelected = eczemaDropdown?.querySelector('.dropdown-selected');
//const dropdownOptionsBox = eczemaDropdown?.querySelector('.dropdown-options');

//if (eczemaDropdown && dropdownSelected && dropdownOptionsBox) {
  // Open/close
  //dropdownSelected.addEventListener('click', (e) => {
    ...
    //dropdownOptionsBox.style.display = willOpen ? 'block' : 'none';
  //});

  // Click on an option (event delegation)
  //dropdownOptionsBox.addEventListener('click', (e) => {
    //const option = e.target.closest('div[data-value]');
    //if (!option) return;

    //const rawVal = option.getAttribute('data-value');   // e.g., 'neurodermatitis'
    //const val    = normalizeType(rawVal);               // e.g., 'neuro'
    //const label  = option.textContent;

    // update label + store UI value
    //dropdownSelected.textContent = label;
    //dropdownSelected.setAttribute('data-value', rawVal);
...
//}
  // -------------------------------------------------------------------
  // 6B) After it stopped working:  Custom dropdown (eczema type) 6A didn't work
  // -------------------------------------------------------------------
// --- Custom Dropdown for Eczema Type ---
const eczemaDropdown   = document.getElementById('eczemaDropdown');
const dropdownSelected = eczemaDropdown?.querySelector('.dropdown-selected');
const dropdownOptions  = eczemaDropdown?.querySelector('.dropdown-options');

if (eczemaDropdown && dropdownSelected && dropdownOptions) {
  // open/close when clicking the selected box
  dropdownSelected.addEventListener('click', (e) => {
